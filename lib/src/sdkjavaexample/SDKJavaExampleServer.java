 ...
 * </pre>
 */
public class SDKJavaExampleServer extends JsonServerServlet {
    ...
    public SDKJavaExampleServer() throws Exception {
        super("SDKJavaExample");
        //BEGIN_CONSTRUCTOR
     ...
     */
    @JsonServerMethod(rpc = "SDKJavaExample.filter_contigs", async=true)
    ...
    @JsonServerMethod(rpc = "SDKJavaExample.status")
    ...
    public static void main(String[] args) throws Exception {
        if (args.length == 1) {
            new SDKJavaExampleServer().startupServer(Integer.parseInt(args[0]));
        } else if (args.length == 3) {
            JsonServerSyslog.setStaticUseSyslog(false);
            JsonServerSyslog.setStaticMlogFile(args[1] + ".log");
            new SDKJavaExampleServer().processRpcCall(new File(args[0]), new File(args[1]), args[2]);
        } else {
